...
Blockly.Blocks["reward_function"] = {
  init: function () {
    ...
    this.setColour(165);
    this.setTooltip("");
    this.setHelpUrl("https://docs.aws.amazon.com/deepracer/latest/developerguide/deepracer-console-train-evaluate-models.html#deepracer-train-models-define-reward-function");
    this.setCommentText("This is a reward function. Every code should go inside this function block of code.");
  },
};
...
Blockly.Blocks["reward"] = {
 ...
 this.setTooltip("");
 this.setHelpUrl("https://docs.aws.amazon.com/deepracer/latest/developerguide/deepracer-console-train-evaluate-models.html#deepracer-train-models-define-reward-function");
 this.setCommentText("Use this block to modify the value of reward. The default value is 1. \nAny value between 0 and 1 is allowed.");
  }
};
...
Blockly.Blocks["reward_access"] = {
  init: function () {
    ...
    this.setTooltip("");
    this.setHelpUrl("");
 this.setCommentText(`Use this variable to access the value of reward anytime.\n
...
parameters.forEach((parameter) => {
  Blockly.Blocks[`${parameter}_init`] = {
    init: function () {
      ...
      this.setColour(30);
      this.setTooltip("");
      this.setHelpUrl("https://docs.aws.amazon.com/deepracer/latest/developerguide/deepracer-reward-function-input.html");
    },
  };
...
Blockly.Blocks["wheels_on_track_check"] = {
  init: function () {
    ...
    this.setColour(230);
    this.setTooltip("");
    this.setHelpUrl("https://docs.aws.amazon.com/deepracer/latest/developerguide/deepracer-reward-function-input.html#reward-function-input-all_wheels_on_track");
    this.setCommentText("This block will determine if all wheels are on track. \nIf all wheels are not on track, the reward will be 0.0001.\nWe want to set the reward to a low value as soon as the car goes off track.");
  },
  // onchange: function() {
  //   let allBlocks = getBlocks();
...
Blockly.Blocks["markers_init"] = {
  init: function () {
      ...
      this.setColour(30);
      this.setTooltip("");
      this.setHelpUrl("https://docs.aws.amazon.com/deepracer/latest/developerguide/deepracer-reward-function-input.html#reward-function-input-track_width");
      this.setCommentText("This block will declare three markers.\nThese markers will represent the 10%, 25% and 50% width of the track.\nWe will use these markers to determine if the car is moving close to the center of the track or not.");
  },
  // onchange: function(){
  //   let allBlocks = getBlocks();
...
Blockly.Blocks["marker1_access"] = {
  init: function () {
    this.appendDummyInput().appendField('marker1');
      ...
      this.setColour(30);
      this.setTooltip("");
      this.setHelpUrl("https://docs.aws.amazon.com/deepracer/latest/developerguide/deepracer-reward-function-input.html#reward-function-input-distance_from_center");
  },
  onchange: function(){
    let allBlocks = getBlocks();
...
Blockly.Blocks['check_steering'] = {
  init: function() {
    ...
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("https://docs.aws.amazon.com/deepracer/latest/developerguide/deepracer-reward-function-input.html#reward-function-input-steering_angle");
  },
  // onchange: function() {
  //   let allBlocks = getBlocks();
